                                        ...
                                        ((s = {
                                            ...
                                            (f = function (t, e, s) {
                                                try {
                                                    var n = (function (t) {
                                                            for (
                                                                var e = (t = i(t, o && o.formats)).match(a),
                                                                    s = e.length,
                                                                    n = 0;
                                                                n < s;
                                                                n += 1
                                                    ...
                                                    return g
                                                        ...
                                                        : s
                                                            ? new Date(Date.UTC(y, v, b, w, C, x, M))
                                                            : new Date(y, v, b, w, C, x, M);
                                                } catch (t) {
                                                    return new Date("");
                                                }
                                            }),
                                    ...
                                    if (e)
                                        switch (e) {
                                            case "ISO_8601":
                                                ...
                                                break;
                                            case "RFC_2822":
                                                s = i(t, "ddd, MM MMM YYYY HH:mm:ss ZZ").format(
                                                    "YYYYMMDD"
                                                );
                                                break;
                                            case "MYSQL":
                    ...
                    class u {
                        ...
                        render(t) {
                            ...
                            if (
                                ...
                                this.body ||
                                ((this.body = a("tbody")), this.table.appendChild(this.body)),
